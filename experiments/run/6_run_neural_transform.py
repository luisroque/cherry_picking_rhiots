    ...
    for group in groups:
        ...
        for transformation in transformations:
            for version in range(1, n_versions + 1):
                print(f"Processing {data_name} - {group} | Transformation: {transformation}, Version: {version}")
                ...
                try:
                    ds = pd.read_csv(transformed_file_path)
                ...
                try:
                    ...
                    print(f"Results saved for {data_name} - {group} - {transformation} - v{version}")
